export default {
    ...
    config: {
        ...
        channelEditor: {
            ...
            fetchAllSuccess: "已获取 {{count}} 个 Key 的模型列表",
            fetchAllPartial: "已获取 {{success}} 个 Key，{{failed}} 个 Key 获取失败",
            title: "配置渠道",
            name: "渠道名称",
            protocol: "协议",
            baseUrl: "接口地址",
            ...
            modelApiKeysDescription: "添加专用 Key 后可一键获取全部 Key 的模型列表；只有已绑定 Key 的模型才会进入可选列表。",
