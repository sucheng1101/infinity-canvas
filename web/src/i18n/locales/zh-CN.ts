export default {
    ...
    settingsPanels: {
        ...
        model: { channel: "选择渠道", select: "选择模型", assign: "请先在渠道里为{{capability}}指定模型", noMatch: "暂无匹配的{{capability}}模型", addFirst: "请先到配置里添加渠道和模型", capabilities: { image: "生图", video: "视频", text: "文本", audio: "音频" } },
    },
    ...
    config: {
        ...
        channels: {
            description: "渠道固定为 codex.helpapis.com 和 helpapis.com；每个渠道支持通用 Key 和任意数量的模型 Key，可用各 Key 拉取模型并手动绑定。",
            add: "新增渠道",
            unnamed: "未命名渠道",
        ...
        channelEditor: {
            ...
            modelApiKeysDescription: "添加 Key 后获取其支持列表并手动选择模型；同一模型只绑定一条 Key。",
            ...
            noModelApiKeys: "尚未添加模型专用 Key，所有模型使用通用 Key。",
            models: "渠道模型",
