export default {
    ...
    settingsPanels: {
        ...
        model: { channel: "Select provider", select: "Select model", assign: "Assign a model for {{capability}} in the provider settings", noMatch: "No matching {{capability}} models", addFirst: "Add a provider and models in Settings first", capabilities: { image: "image generation", video: "video", text: "text", audio: "audio" } },
    },
    ...
    config: {
        ...
        channels: {
            description: "Providers are fixed to codex.helpapis.com and helpapis.com. Each provider supports a general key and any number of model keys that can fetch and bind their supported models.",
            add: "Add provider",
        ...
        channelEditor: {
            ...
            modelApiKeysDescription: "Add a key, fetch its supported models, and select which models use it. Each model can belong to one key.",
            ...
            noModelApiKeys: "No model-specific keys. All models use the general key.",
