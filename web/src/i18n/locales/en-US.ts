export default {
    ...
    config: {
        ...
        channelEditor: {
            ...
            fetchAllSuccess: "Fetched models for {{count}} keys",
            fetchAllPartial: "Fetched {{success}} keys; {{failed}} keys failed",
            ...
            modelApiKeysDescription: "Add dedicated keys, then fetch all key model lists at once. Each selectable model must be bound to a key.",
