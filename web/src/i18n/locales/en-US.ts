export default {
    ...
    config: {
        ...
        channels: {
            description: "Providers are fixed to codex.helpapis.com and helpapis.com. Each provider supports a general key and capability-specific keys, plus model fetching, capability assignment, and request scripts.",
            add: "Add provider",
        ...
        channelEditor: {
            ...
            defaultApiKeyDescription: "Used to fetch models and as the fallback when a capability-specific key is empty.",
            capabilityApiKeys: "Capability-specific keys",
            capabilityApiKey: "{{capability}} key",
            capabilityApiKeyPlaceholder: "Uses the general key when empty",
            capabilityApiKeysDescription: "Requests prefer the key matching the model capability, useful when image and text permissions require different keys.",
