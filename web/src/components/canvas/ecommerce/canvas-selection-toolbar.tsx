...
import { Group, Play, Ungroup } from "lucide-react";
...
export function CanvasSelectionToolbar({
    ...
    const showActions = showToolbar && (canGroup || canUngroup || canGenerate);
    ...
    return (
        <>
            ...
            {showActions ? (
                ...
                >
                    {canGenerate && onGenerate ? <SelectionAction title={t("canvas.nodeToolbar.batchGenerateTitle")} label={t("canvas.nodeToolbar.batchGenerate")} icon={<Play className="size-4" />} onClick={onGenerate} /> : null}
